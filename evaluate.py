...
df = pd.read_csv("headlines_by_category.csv")
df["predicted_category"] = df["heading"].apply(classify)
df.to_csv("headlines_by_category.csv", index=False)
...
print(f"Accuracy:  {correct / len(df) * 100:.1f}%")
